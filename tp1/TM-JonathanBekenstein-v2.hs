...
descomposicionEnPrimosDesde n i
...
numeroDeDescomposiciones n = numeroDeDescomposicionesDesde n 2

numeroDeDescomposicionesDesde :: Integer -> Integer -> Integer
numeroDeDescomposicionesDesde n i
    | i > nDiv2 = 0
    | sonPrimos && i == nDiv2 = 1
    | sonPrimos = 2 + numeroDeDescomposicionesDesde n (i+1)
